...
class localmse2(nn.Module):
  def __init__(self):
    super(localmse2,self).__init__()
    self.name='local-size MSE loss'
  def forward(self,pred,gt,mask,bs=1):
    #gt mask
    ...
    cpgt=gt[:,:,i2:x2,i3:x3]
    cppred=F.interpolate(cppred,(384,384))
    cpgt=F.interpolate(cpgt,(384,384))
